...
int main()
{
    ...
    gotoxy(20,17);printf("> Enter ID:");gotoxy(32,17);scanf("%d",&check.id_no);
    printf("\n\n");

    system("cls");
    console(1,0,100,1); gotoxy(40,1);printf(">>> RECORD  LIST <<<");
    for(i=1;i<100;i++){ gotoxy(1+i,6); printf("%c",196); }
    gotoxy(1,3);printf(" Searching for the ID:"); gotoxy(25,3);printf("%d",check.id_no);
